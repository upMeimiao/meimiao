...
const storageClient = new Redis('redis://:C19prsPjHs52CHoA0vm@192.168.1.31:6379/6', {
...
const mSpiderClient = new Redis('redis://:C19prsPjHs52CHoA0vm@192.168.1.31:6379/7', {
  reconnectOnError(err) {
    if (err.message.slice(0, 'READONLY'.length) === 'READONLY') {
      return true;
    }
