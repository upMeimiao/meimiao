...
const _getInactiveTask = () => {
    const options = {
        method: 'GET',
        url: 'http://r-m5e43f2043319e64.redis.rds.aliyuncs.com:3000/api/jobs/inactive/0...500/desc',
        headers: {
...
const _getFailedTask = () => {
    const options = {
        method: 'GET',
        url: 'http://r-m5e43f2043319e64.redis.rds.aliyuncs.com:3000/api/jobs/failed/0...500/desc',
        headers: {
            authorization: 'Basic dmVyb25hOjIzMTk0NDY='
        }
    }
