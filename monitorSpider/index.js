...
class spiderCore {
    ...
    setTask () {
        ...
        yidian_rule.minute = [11,31,51]
        tudou_rule.minute = [12,32,52]
        baomihua_rule.minute = [13,33,53]
        ku6_rule.minute = [14,34,54]
        btime_rule.minute = [15,35,55]
        weishi_rule.minute = [16,36,56]
        xiaoying_rule.minute = [17,37,57]
        budejie_rule.minute = [18,38,58]
        neihan_rule.minute = [19,39,59]
        yy_rule.minute = [0,20,40]
        ...
        pptv_rule.minute = [11,31,51]
        xinlan_rule.minute = [12,32,52]
        v1_rule.minute = [13,33,53]
        fengxing_rule.minute = [14,34,54]
        huashu_rule.minute = [15,35,55]
        baofeng_rule.minute = [16,36,56]
        baiduvideo_rule.minute = [17,37,57]
