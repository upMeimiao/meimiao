...
class commentScheduler {
  ...
  getTask() {
    ...
    //   }
    // );
    request.get('http://staging-dev.meimiaoip.com/index.php/Spider/videoCommO/getUpdateV?limit=500&platform=34-35-36-38-17-18-19-23-21-24-26-27-28-29-30-31-32-33-7-10-12-15-22', (err, res, body) => {
      if (err) {
