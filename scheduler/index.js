...
class scheduler {
            ...
            ( err, cli ) => {
                ...
                switch (osName){
                    case 'servant_3':
                        ...
                        // rule.minute = [0,4,8,12,16,18,22,25,27,30,32,34,36,38,40,42,44,46,48,50,52,54,56,58]
                        break
                    case 'iZ28ilm78mlZ':
                        // rule.minute = [2,6,10,14,17,20,23,26,28,31,33,35,37,39,41,43,45,47,49,51,53,55,57]
    ...
    createQueue ( raw ) {
        if( (raw.p == 12 && (raw.id == '102599789' || raw.id == '113077877' || raw.id == '120663556' || raw.id == '113077233' || raw.id == '113077988' || raw.id == '120663663' || raw.id == '120663623' || raw.id == '113077745' || raw.id == '113077370' || raw.id == '366571453' || raw.id == '120663699'))|| (raw.p == 6 && raw.id == '6116731501') || (raw.p == 2 && raw.id == '1045961206') || (raw.p == 1 && (raw.id == '1051381206' || raw.id == '1125009518'))){
            return
        }
