        ...
        if(proxyStatus && proxy){
          ...
          request.get( logger, option, (err,result) => {
            ...
            if(result.has_more === false){
              if((task.id == '5800750710' || task.id == '6037403091' || task.id == '5800835780' || task.id == '51174033215') && index === 0){
                sign = false
                return cb()
              }
              times++
          ...
          this.core.proxy.need(times, (err, _proxy) => {
            ...
            request.get( logger, option, (err,result) => {
              ...
              if(result.has_more === false){
                if((task.id == '5800750710' || task.id == '6037403091'  || task.id == '5800835780' || task.id == '51174033215' || task.id == '52378452732') && index === 0){
                  sign = false
                  return cb()
                }
                times++
