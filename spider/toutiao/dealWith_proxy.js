        ...
        if (proxyStatus && proxy) {
          ...
          request.get(logger, option, (error, result) => {
            ...
            if (result.has_more === false) {
              if ((task.id === '1569456576470017' || task.id === '5836890714' || task.id === '51090620837' || task.id === '51919907973' || task.id === '6104624179' || task.id === '3785249520' || task.id === '52378452732' || task.id === '52673486454' || task.id === '1564257331844098' || task.id === '6357263281' || task.id === '6276458172' || task.id === '6542432526' || task.id === '6104275014' || task.id === '6976935001' || task.id === '6037403091' || task.id === '51174033215') && index === 0) {
                sign = false;
                cb();
                return;
              }
