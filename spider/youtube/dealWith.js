...
class dealWith {
    ...
    channel(task, callback) {
        ...
        request(options, (error, response, body) => {
            ...
            body = null
            this.channelDeal(task, fansInfo, listArg, (err, result) => {
                callback()
            })
        });
    }
...
function _class(raw) {
    ...
    for (let [index, elem] of raw[0].metadata_row_container.rows.entries()) {
